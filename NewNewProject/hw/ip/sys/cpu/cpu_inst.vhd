	...
	u0 : component cpu
		port map (
			...
			ci_custom0_clk               => CONNECTED_TO_ci_custom0_clk,               --          ci_custom0.clk
			ci_custom0_reset             => CONNECTED_TO_ci_custom0_reset,             --                    .reset
			ci_custom0_data0             => CONNECTED_TO_ci_custom0_data0,             --                    .data0
			ci_custom0_data1             => CONNECTED_TO_ci_custom0_data1,             --                    .data1
			ci_custom0_ctrl              => CONNECTED_TO_ci_custom0_ctrl,              --                    .ctrl
			ci_custom0_alu_result        => CONNECTED_TO_ci_custom0_alu_result,        --                    .alu_result
			ci_custom0_enable            => CONNECTED_TO_ci_custom0_enable,            --                    .enable
			ci_custom0_result            => CONNECTED_TO_ci_custom0_result,            --                    .result
			ci_custom0_done              => CONNECTED_TO_ci_custom0_done,              --                    .done
