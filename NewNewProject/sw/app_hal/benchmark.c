...
int main()
{
    ...
    //     KERNAL(kernel, 0xFF01FF01, 0, 0);
        
    //     printf("[Kernel]: 0x%08X\n", kernel);
        
    // }
    
    KERNAL(0xFF01FF01, 0x00, 0, 0);
    KERNAL(0x01FFFF01, 0x00, 0, 0);
    KERNAL(0xFF0101FF, 0x00, 0, 0);
    KERNAL(0x01FF01FF, 0x00, 0, 0);
